function installRosURToolbox(replaceExisting)
% INSTALLROSURTOOLBOX installs RosURToolbox for MATLAB.
%   INSTALLROSURTOOLBOX installs RosURToolbox into the following 
%   locations:
%                             Source: Destination
%           RosURToolboxFunctions: matlabroot\toolbox\rosur
%
%   INSTALLROSURTOOLBOX(true) installs RosURToolbox regardless of
%   whether a copy of the RosURToolbox exists in the MATLAB root.
%
%   INSTALLROSURTOOLBOX(false) installs RosURToolbox only if no copy 
%   of the RosURToolbox exists in the MATLAB root.
%
